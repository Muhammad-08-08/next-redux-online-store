            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    <div className="flex-1 space-y-10">
                        <div>
                            <h3 className="text-lg font-semibold mb-4">1. Sizning ma'lumotlaringiz</h3>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <input type="text" placeholder="Telefon" defaultValue="+998" className="border border-gray-300 rounded-lg px-4 py-2 w-full" />
                                <input type="text" placeholder="Ism" className="border border-gray-300 rounded-lg px-4 py-2 w-full" />
                                <input type="text" placeholder="Familiya" className="border border-gray-300 rounded-lg px-4 py-2 w-full" />
                            </div>
                        </div>

                        <div>
                            <h3 className="text-lg font-semibold mb-4">2. Qabul qilish usuli</h3>
                            <div className="flex items-center gap-4 mb-6">
                                <button className="border border-yellow-400 text-yellow-600 bg-yellow-100 font-medium rounded-full px-6 py-2">Yetkazib berish</button>
                                <button className="border border-gray-300 rounded-full px-6 py-2 text-gray-600">Dokondan olib ketish</button>
                            </div>
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-4">3. Tolov usulini tanlang</h3>
                            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-4">
                                {['Payme', 'Click', 'Onlayn karta orqali', 'Qabul qilinganda', 'Muddatli tolov'].map((method, idx) => (
                                    <div key={idx} className="border border-gray-300 rounded-lg px-4 py-3 text-center text-sm text-gray-800 cursor-pointer hover:shadow">
                                        {method}
                                    </div>
                                ))}
                            </div>
